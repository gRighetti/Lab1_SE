...
int main(void) {
	...
	while (1) {
		...
		if (Value_Pote > 260 && Value_Pote <= 420) {
			...
			rgb_setBright(RGB_AZUL, 1000 / 140 * Value_Pote);
			rgb_setBright(RGB_VERDE, 100);
		}
		if (Value_Pote > 420 && Value_Pote <= 590) {
			...
			rgb_setBright(RGB_VERDE, 1000 - (1000 / 170 * Value_Pote));
		}
		if (Value_Pote > 590 && Value_Pote <= 790) {

			rgb_setBright(RGB_ROJO, 1000 / 140 * Value_Pote);
			rgb_setBright(RGB_AZUL, 100);
		...
		if (Value_Pote > 790) {
			...
			rgb_setBright(RGB_ROJO, 100);
			rgb_setBright(RGB_AZUL,1000 - (1000 / 170 * Value_Pote));
			rgb_setBright(RGB_VERDE, 0);
		}
